...
export default function CheckoutTab(props) {
    ...
    const operations = <Fragment>
        ...
        }}> <div style={{ width: 50, height: 50, display: 'flex', justifyContent: 'center', alignItems: 'center' }} className="text-2xl ml-5 rounded-full bg-red-200">{userLogin.hoTen.substr(0, 1)}</div>Hello ! {userLogin.hoTen}</button> <button onClick={() => {
